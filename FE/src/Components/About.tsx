...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center p-6 max-w-2xl mx-auto text-center">
      <h1 className="text-3xl font-bold text-blue-700 mb-4">About ALTERNATIVE</h1>
      <p className="text-gray-700 text-lg mb-4">
      ALTERNATIVE is a platform dedicated to educating people on where products,
      ...
      <p className="text-gray-700 text-lg font-semibold mb-4">
        As a playful twist, ALTERNATIVE adopts the term "friendly countries" in
